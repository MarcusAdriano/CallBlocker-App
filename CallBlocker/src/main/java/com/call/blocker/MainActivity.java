...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView () {
        adapter = new RecyclerViewAdapter(mContext, mContactDb.getAll(ContactDB.KEY_DESCRIPTION));
